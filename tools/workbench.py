...
# billing guard from the mcp-cli-terminal-surface ADR.
...
<style>
 ...
 #bar {{ padding: .4rem .6rem; display: flex; gap: .4rem;
        align-items: center; border-bottom: 1px solid #8884; }}
 #bar button {{ padding: .15rem .6rem; cursor: pointer; }}
...
<div id="right">
 <div id="bar">
   <span>open in:</span>{term_buttons}
   <span class="hint">your harness, beside the knowledge — MCP wired
via install-agent</span>
 </div>
 <div id="term"></div>
</div>
