...
The pitch's deepdive studied a shipped desktop-editor implementation
in the space rather than guessing. Their terminal is Electron-only — a per-window
...
- **An Electron/desktop app** (the studied prior art's shape) —
