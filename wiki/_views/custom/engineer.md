...
| brain/adrs/kernel-manifest-instancing.md | Instances are born by manifest: init --full copies the mechanism and the kernel's decision trail, scaffolds the rest fre | accepted | medium | 2026-07-10 |
